...
function ManagerCreate() {
  ...
  const designations = ["Project Manager", "Senior Manager", "Junior Manager"];
    ...
    <div className="form-wrapper">
      ...
      <div className="form-card">
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', gap: '15px' }}>
          ...
          <h3 style={{ margin: 0 }}>Create Manager</h3>
        </div>
            ...
            {isDeptDropdownOpen && (
              <div className="custom-dropdown-menu" style={{
                  ...
                  <div 
                      ...
                      onClick={() => { setForm({...form, department: ""}); setIsDeptDropdownOpen(false); }}
                      style={{
                          padding: '12px 15px',
                          cursor: 'pointer',
                          fontSize: '14px',
                  ...
                  {departments.map((d) => (
                      <div 
                          key={d}
                          className="dropdown-item"
                          onClick={() => { setForm({...form, department: d}); setIsDeptDropdownOpen(false); }}
                          style={{
                              padding: '12px 15px',
                              cursor: 'pointer',
                              fontSize: '14px',
